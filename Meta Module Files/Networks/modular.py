...
# Positional Encoding from 'Attention is all you need (3.5)'
...
# Cross attention network - CA in article for Visual Encoder
class GA(nn.Module):
	def __init__(self, hidden_size, head_num, ff_size, dropout, hidden_size_head):
...
# Moved into TreeTransformer class
