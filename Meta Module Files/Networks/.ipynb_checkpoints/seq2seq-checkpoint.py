...
class TransformerDecoder(nn.Module):
    ...
    def translate_batch_beam(self, de_vocab, src_seq, n_bm, max_token_seq_len=30):
        ''' Translation work in one batch '''
        #device = src_seq.device(device)
        ...
        with torch.no_grad():
            ...
            for _ in batch_hyp:
                ...
                if not finished:
                    result.append(_[0])
            return result, batch_hyp, batch_scores
